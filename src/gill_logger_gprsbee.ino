...
const char *sketchName = "gill_logger_gprsbee.ino";
// Logger ID, also becomes the prefix for the name of the data file on SD card
const char *LoggerID = "HMB";
...
#include <sensors/GillGMX200.h>

const char *GMXSDI12address = "0";  // The SDI-12 Address of the CTD
const uint8_t GMXNumberReadings = 1;  // The number of readings to average
const int8_t SDI12Power = -1;  // Pin to switch power on and off (-1 if unconnected)
const int8_t SDI12Data = 7;  // The SDI12 data pin
// Create a Gill GMX200 sensor object to read D0 message
GillGMX200 gmx(*GMXSDI12address, SDI12Power, SDI12Data, GMXNumberReadings);

#include <sensors/GillGMX200D3.h>

const char *GMXSDI12addressD3 = "0";   // The SDI-12 Address of the CTD
const uint8_t GMXNumberReadingsD3 = 1; // The number of readings to average
const int8_t SDI12PowerD3 = -1;        // Pin to switch power on and off (-1 if unconnected)
const int8_t SDI12DataD3 = 7;          // The SDI12 data pin
// Create a Gill GMX200 sensor object to read D3 message
GillGMX200D3 gmx3(*GMXSDI12addressD3, SDI12PowerD3, SDI12DataD3, GMXNumberReadingsD3);
...
Variable *variableList[] = {
    ...
    new GillGMX200_Dw(&gmx, "Dw"),
    new GillGMX200_Sw(&gmx, "Sw"),
    new GillGMX200_Dc(&gmx, "Dc"),
    new GillGMX200_Sc(&gmx, "Sc"),
	new GillGMX200D3_Dm(&gmx3, "Dm"),
    new GillGMX200D3_Sm(&gmx3, "Sm"),
...
const char *registrationToken = "%)+s^4v]";   // Make this the Hologram Device Key
